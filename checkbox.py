...
class Checkbox:
    def __init__(self, text, size, x, y):
        ...
        checked = pygame.transform.smoothscale(pygame.image.load("backgrounds/box_checked.png"), (self.text.get_size()[1] - 10, self.text.get_size()[1]- 10))
        unchecked = pygame.transform.smoothscale(pygame.image.load("backgrounds/box_unchecked.png"), (self.text.get_size()[1] - 10, self.text.get_size()[1] - 10))

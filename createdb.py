...
class User(BaseClass):
    ...
    id: Mapped[int] = mapped_column("id", Integer, primary_key=True, autoincrement=True)
    favorite_id = mapped_column("favorite_id", Integer, ForeignKey("shapes.id"), nullable=True, default=None)
...
class Shape(BaseClass):
    ...
    id: Mapped[int] = mapped_column("id", Integer, ForeignKey("users.favorite_id", name="favorite_id"), primary_key=True, autoincrement=True)
    owner_id: Mapped[int] = mapped_column("owner_id", Integer, ForeignKey("users.id"))

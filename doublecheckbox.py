...
class DoubleCheckbox:
    def __init__(self, text, size, x, y):
        ...
        self.checked_img = pygame.transform.smoothscale(pygame.image.load("backgrounds/box_checked.png"), (self.text.get_size()[1] - int(self.text.get_size()[1]/10), self.text.get_size()[1]- int(self.text.get_size()[1]/10)))
        self.unchecked_img = pygame.transform.smoothscale(pygame.image.load("backgrounds/box_unchecked.png"), (self.text.get_size()[1] - int(self.text.get_size()[1]/10), self.text.get_size()[1] - int(self.text.get_size()[1]/10)))
